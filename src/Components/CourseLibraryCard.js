...
const CourseLibraryCard = () => {
  ...
  return (
    <div>
      ...
      md:gap-[19px] md:pt-[25px] xl:pt-[25px]">
        {courses.length > 0 &&
          courses.map((obj) => (
            <div className="pt-[55px] md:pt-[15px] xl:pt-[10px]">
              <div className="w-[356px] h-[236px] shadow-md shadow-gray-300 bg-white rounded-[25px] xl:w-[430px]">
                <div
                  className="z-0 relative w-[356px] h-[145px] text-white rounded-t-[25px] xl:w-[430px]"
                  style={{
                ...
                >
                  <div
                    className="z-10 absolute mt-[30px] ml-[30px] w-[3px] h-[22px] border-l-[4px] sm:w-[287px] xl:w-[430px]"
                    style={{ borderColor: `${obj.color}` }}
                  ></div>
                  <h3 className="absolute z-50  pl-[46px] pt-[24px] gap-10 text-[24px] font-bold">
                    {obj.title}
                  </h3>
                  <p className="absolute z-50 pl-[33px] pt-[77px] text-[14px] font-semibold  xl:w-[350px] xl:text-[14px] sm:w-[269px] sm:h-[36px] sm:text-[11px]">
                    {obj.description}
                  </p>
