  ...
  return (
    <div>
      ...
      sm:gap-4">
        {courses.length > 0 &&
          courses.map((obj) => (
            <div className="pt-[55px] md:pt-[15px] xl:pt-[10px] sm:pt-[25px]">
              <div className="w-[356px] h-[236px] shadow-md shadow-gray-300 bg-white rounded-[25px] xl:w-[430px] sm:w-[287px]">
                <div
