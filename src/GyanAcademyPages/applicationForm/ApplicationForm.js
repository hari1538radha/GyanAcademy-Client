  ...
  return (
    <div className=" flex font-poppins flex-col  justify-center items-center pt-28 pb-28 bg-gradient-to-b from-[#E1F3FF] to-[#E4D7FF] ">
      <div className=" flex flex-col  justify-center items-center w-full ">
        ...
        <div className="flex flex-row flex-wrap w-[756px] gap-x-10 mb-[40px] ">
          {fields.map((obj) => (
            <div className="w-[358px] text-[16px] font-normal">
              ...
              <input
                placeholder={obj[1]}
                className="w-[358px] pl-5 h-[53px] rounded-[5px] mb-[35px]"
              />
            </div>
          ))}
          <div className="w-[358px] text-[16px] font-normal ">
            <label className="mb-[10px] font-semibold text-[#484B4D] ">
              Category *
            </label>
            <br></br>
            <select
              name="Category"
              className="w-[358px] text-slate-600 pl-5 h-[53px] rounded-[5px] bg-white mb-[35px]"
            >
        ...
        <div className="">
          <label className="text-[16px] font-semibold">Upload resume *</label>
          <div className="">
            <label className="flex justify-center w-[755px] h-[115px]  transition bg-white border-2 border-gray-500 mt-4  mb-8 border-dashed rounded-md appearance-none cursor-pointer hover:border-gray-400 focus:outline-none">
              <span className="flex items-center  flex-col justify-center">
                ...
                <span className="font-medium mt-2 text-gray-400">
