  ...
  return (
    <div className=" flex font-poppins flex-col  justify-center items-center pt-28 pb-28 bg-gradient-to-b from-[#E1F3FF] to-[#E4D7FF] sm:pt-10 sm:pb-10">
      <div className=" flex flex-col justify-center items-center w-full">
        <form className=" sm:flex sm:flex-col sm:items-center" onSubmit={handelFormData}>
          <h1 className="text-[42px] font-medium mb-[10px] md:flex md:justify-center sm:text-[16px]">Apply Here </h1>
          ...
          <div className="md:flex md:flex-col md:items-center ">
            <label className="text-[16px] font-semibold sm:text-[9px]">Upload resume *</label>
            <div className=" ">
              <label className="flex justify-center w-[755px] h-[115px]  transition bg-white border-2 border-gray-500 mt-4  mb-8 border-dashed rounded-md appearance-none cursor-pointer hover:border-gray-400 focus:outline-none md:w-[600px] sm:w-[250px]">
